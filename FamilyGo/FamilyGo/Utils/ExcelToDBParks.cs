...
{
    public class ExcelToDBParks
    {
        public class ExcelToDBPark
        {
            public void Page_Load()
            {
                FileSvr fileSvr = new FileSvr();
                System.Data.DataTable dt = fileSvr.GetExcelDatatable("E:\\MIT\\5120\\Project\\data\\Parks.xlsx", "Sheet1");
        ...
        class FileSvr
        {
            ...
            public int InsetData(System.Data.DataTable dt)
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    facilities = dr["facilities"].ToString().Trim();
