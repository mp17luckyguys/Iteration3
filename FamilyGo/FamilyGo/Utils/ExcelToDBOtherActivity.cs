...
{
    public class ExcelToDBOtherActivity
    {
        public class ExcelToDBOtherActicityPlaces
        {
            public void Page_Load()
            {
                FileSvr fileSvr = new FileSvr();
                System.Data.DataTable dt = fileSvr.GetExcelDatatable("E:\\MIT\\5120\\Project\\data\\activity.xlsx", "Sheet1");
        ...
        class FileSvr
        {
            ...
            public int InsetData(System.Data.DataTable dt)
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    address = dr["Address"].ToString().Trim() + ',' + dr["suburb"].ToString().Trim();
                    suburb = dr["suburb"].ToString().Trim();
                    facilities = dr["Description"].ToString().Trim();
